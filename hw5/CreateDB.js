...
connection.query('CREATE TABLE user(id INT(10) NOT NULL AUTO_INCREMENT, email TEXT, last_check_in TIMESTAMP, last_email_sent TIMESTAMP, notify_list TEXT, message TEXT, UNIQUE(email), PRIMARY KEY(id))',
    function(error, results, fields) {
        if (error) throw error;
    }
);
